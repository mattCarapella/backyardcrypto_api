class ApplicationController < ActionController::API
 ...
 #  end	
  ...
  # def sign_up_params
  #     params.require(:user).permit(:name, :terms_of_service, :username,:age,:password,:password_confirmation, :password, :password_confirmation, :remember_me,:fname,:lname,:wallet, :admin, :moderator, :currentbalance, :payout_to_date, :bio, :facebook, :twitter, :instagram, :linkedin, :youtube, :personal_website, :id_photo, :authentication_token) if params[:user].present?
  #  end
