...
#   event = Event.create(content: "DOGE Event #{index}",  coin_id: 2, user_id: 1, link: Faker::Internet.url, city: Faker::Address.city, state: Faker::Address.state_abbr, country: "United States", description: Faker::Lorem.sentence(12), accepted: true, pending: false, rejected: false, date: Faker::Date.between(2.days.ago, Date.today)) 
# end

# (1..30).to_a.each do |index|
#   event = Event.create(content: "DOGE PendingEvent #{index}",  coin_id: 2, user_id: 1,link: Faker::Internet.url,city: Faker::Address.city, state: Faker::Address.state_abbr, country: "United States", description: Faker::Lorem.sentence(12), accepted: false, pending: true, rejected: false, date: Faker::Date.between(2.days.ago, Date.today)) 
# end
...
Question.create!(ques_num: 1, id: 16, content:  "<p>PENDING Overview sample BTC. Overview sample BTC. Overview sample BTC. Overview sample BTC. Overview sample BTC. Overview sample BTC. Overview sample BTC. Overview sample BTC. Overview sample BTC. Overview sample BTC. Overview sample BTC. Overview sample BTC. </p>\r\n", user_id: 1, coin_id: 1, accepted: false, pending: true, rejected: false)

# (1..30).to_a.each do |index|
#   event = Event.create(content: "BTC Event #{index}",  coin_id: 1, user_id: 1, link: Faker::Internet.url, city: Faker::Address.city, state: Faker::Address.state_abbr, country: "United States", description: Faker::Lorem.sentence(12), accepted: true, pending: false, rejected: false, start_time: Faker::Time.between(2.days.ago, Date.today, :all)) 
# end

# (1..30).to_a.each do |index|
#   event = Event.create(content: "BTC PendingEvent #{index}",  coin_id: 1, user_id: 1,link: Faker::Internet.url,city: Faker::Address.city, state: Faker::Address.state_abbr, country: "United States", description: Faker::Lorem.sentence(12), accepted: false, pending: true, rejected: false, start_time: Faker::Time.between(2.days.ago, Date.today, :all)) 
# end

# event = Event.create(content: "BTC PendingEvent 1",  coin_id: 1, user_id: 1,link: Faker::Internet.url,city: Faker::Address.city, state: Faker::Address.state_abbr, country: "United States", description: Faker::Lorem.sentence(12), accepted: false, pending: true, rejected: false) 
